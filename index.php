   ...
   <section id="top-navigation" class="container-fluid nopadding">
        ...
        <div class="col-md-12 nopadding">
            <div class="col-md-9 nopadding">
               ...
               <li class="col-xs-4 col-sm-2 nopadding menuitem green">
                  <a href="#" target="_blank" class="hvr-underline-from-center"><i class="fa fa-comments-o"></i><span>Forum</span></a>
               </li>
               <li class="col-xs-4 col-sm-2 nopadding menuitem green">
                  <a href="#" target="_blank" class="hvr-underline-from-center"><i class="fa fa-headphones"></i><span>Discord</span></a>
               </li>
               <li class="col-xs-4 col-sm-2 nopadding menuitem green">
                  <a href="#" target="_blank" class="hvr-underline-from-center"><i class="fa fa-exclamation"></i><span>Bug Tracker</span></a>
               </li>
               <li class="col-xs-4 col-sm-2 nopadding menuitem green">
   ...
   <div class="container-fluid nopadding">
      <div class="row wow fadeInDown" data-wow-delay=".2s" data-wow-offset="10">
         <div class="col-md-6 cv-link">
            ...
            <a class="uppercase" href="#">Forum</a>
            <a class="uppercase" href="#">Discord</a>
            <a class="uppercase" href="#">Bug Tracker</a>
         ...
         <div class="social-alignment">
            ...
            <div class="inline-block foot"><a href="#" target="_blank"><i class="fa fa-facebook"></i></a></div>
            <div class="inline-block foot"><a href="#" target="_blank"><i class="fa fa-twitter"></i></a></div>
